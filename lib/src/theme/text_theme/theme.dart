...
class ArkTextTheme {
  factory ArkTextTheme({
    ...
    return ArkTextTheme.custom(
      h1Large: h1Large ?? ArkTextDefaultTheme.h1Large(family: effectiveFamily),
      h1: h1 ?? ArkTextDefaultTheme.h1(family: effectiveFamily),
      h2: h2 ?? ArkTextDefaultTheme.h2(family: effectiveFamily),
      h3: h3 ?? ArkTextDefaultTheme.h3(family: effectiveFamily),
      h4: h4 ?? ArkTextDefaultTheme.h4(family: effectiveFamily),
      p: p ?? ArkTextDefaultTheme.p(family: effectiveFamily),
      blockquote:
      blockquote ??
          ArkTextDefaultTheme.blockquote(family: effectiveFamily),
      table: table ?? ArkTextDefaultTheme.table(family: effectiveFamily),
      list: list ?? ArkTextDefaultTheme.list(family: effectiveFamily),
      lead: lead ?? ArkTextDefaultTheme.lead(family: effectiveFamily),
      large: large ?? ArkTextDefaultTheme.large(family: effectiveFamily),
      small: small ?? ArkTextDefaultTheme.small(family: effectiveFamily),
      muted: muted ?? ArkTextDefaultTheme.muted(family: effectiveFamily),
  ...
  factory ArkTextTheme.fromGoogleFont(
      GoogleFontBuilder fontBuilder, {
        ArkTextTheme? textTheme,
      }) {
    final effectiveTextTheme =
        textTheme ?? ArkDefaultThemeVariant.defaultTextTheme;
  ...
  ArkTextTheme merge(ArkTextTheme? other) {
