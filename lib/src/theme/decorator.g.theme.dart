...
mixin _$ArkDecoration {
  bool get canMerge => true;

  static ArkDecoration? lerp(ArkDecoration? a, ArkDecoration? b, double t) {
    if (identical(a, b)) {
      return a;
    }
    ...
    return ArkDecoration(
      ...
      focusedBorder: ArkBorder.lerp(a.focusedBorder, b.focusedBorder, t),
      errorBorder: ArkBorder.lerp(a.errorBorder, b.errorBorder, t),
      secondaryBorder: ArkBorder.lerp(a.secondaryBorder, b.secondaryBorder, t),
      secondaryFocusedBorder: ArkBorder.lerp(
        a.secondaryFocusedBorder,
        b.secondaryFocusedBorder,
        t,
      ),
      secondaryErrorBorder: ArkBorder.lerp(
  ...
  ArkDecoration copyWith({
    TextStyle? labelStyle,
    TextStyle? errorLabelStyle,
    ArkBorder? border,
    ArkBorder? focusedBorder,
    ArkBorder? errorBorder,
    ArkBorder? secondaryBorder,
    ArkBorder? secondaryFocusedBorder,
    ArkBorder? secondaryErrorBorder,
    ...
    final _this = (this as ArkDecoration);
  ...
  ArkDecoration merge(ArkDecoration? other) {
    final _this = (this as ArkDecoration);
  ...
  bool operator ==(Object other) {
    ...
    final _this = (this as ArkDecoration);
    final _other = (other as ArkDecoration);
