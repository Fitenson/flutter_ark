...
@themeGen
@immutable
class ArkDecoration with _$ArkDecoration {
  const ArkDecoration({
    bool canMerge = true,
    this.border,
    this.focusedBorder,
  ...
  static const ArkDecoration none = ArkDecoration(
    canMerge: false,
    border: ArkBorder.none,
    focusedBorder: ArkBorder.none,
    errorBorder: ArkBorder.none,
    secondaryBorder: ArkBorder.none,
    secondaryFocusedBorder: ArkBorder.none,
    secondaryErrorBorder: ArkBorder.none,
  );

  final TextStyle? labelStyle;
  final TextStyle? errorLabelStyle;
  final ArkBorder? border;
  final ArkBorder? focusedBorder;
  final ArkBorder? errorBorder;
  final ArkBorder? secondaryBorder;
  final ArkBorder? secondaryFocusedBorder;
  final ArkBorder? secondaryErrorBorder;
...
class ArkDecorator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryDecoration = switch (border) {
      final ArkRoundedSuperellipseBorder border => ShapeDecoration(
      ...
      final ArkBorder? border => BoxDecoration(
    ...
    if (secondaryBorder != null && !effectiveDisableSecondaryBorder) {
      decorated = Padding(
        ...
        child: CustomPaint(
          foregroundPainter: ArkOutwardBorderPainter(
...
class ArkOutwardBorderPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant ArkOutwardBorderPainter oldDelegate) {
