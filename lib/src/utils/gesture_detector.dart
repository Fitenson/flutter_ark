...
class ArkHoverStrategies {
  ...
  final Set<ArkHoverStrategy> hover;
  final Set<ArkHoverStrategy> unhover;
  ...
  bool operator ==(Object other) {
    ...
    return other is ArkHoverStrategies &&
  ...
  ArkHoverStrategies copyWith({
    Set<ArkHoverStrategy>? hover,
    Set<ArkHoverStrategy>? unhover,
    Duration? longPressDuration,
    ValueChanged<bool>? onHoverChange,
  }) {
    return ArkHoverStrategies(
...
class ArkGestureDetector extends StatefulWidget {
  const ArkGestureDetector({
    super.key,
    required this.child,
  ...
  /// {@macro ArkMouseArea.groupId}
  final Object? groupId;

  @override
  State<ArkGestureDetector> createState() => _ArkGestureDetectorState();
}

class _ArkGestureDetectorState extends State<ArkGestureDetector> {
  bool hovered = false;
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveHoverStrategies = widget.hoverStrategies ?? theme.hoverStrategies;
    final gestures = <Type, GestureRecognizerFactory>{};
    final gestureSettings = MediaQuery.maybeGestureSettingsOf(context);

    void setHover(ArkHoverStrategy strategy) {
    ...
    void effectiveOnTapDown(TapDownDetails d) {
      setHover(ArkHoverStrategy.onTapDown);
    ...
    void effectiveOnTap() {
      setHover(ArkHoverStrategy.onTap);
      widget.onTap?.call();
    }

    void effectiveOnTapOutside(PointerDownEvent event) {
      setHover(ArkHoverStrategy.onTapOutside);
    ...
    void effectiveOnTapUp(TapUpDetails d) {
      setHover(ArkHoverStrategy.onTapUp);
      final correctedGlobalPosition = correctGlobalPosition(
        context,
        d.globalPosition,
      );
    ...
    void effectiveOnTapCancel() {
      setHover(ArkHoverStrategy.onTapCancel);
      widget.onTapCancel?.call();
    }

    void effectiveOnDoubleTapDown(TapDownDetails d) {
      setHover(ArkHoverStrategy.onDoubleTapDown);
      final correctedGlobalPosition = correctGlobalPosition(
        context,
        d.globalPosition,
      );
    ...
    void effectiveOnDoubleTapCancel() {
      setHover(ArkHoverStrategy.onDoubleTapCancel);
      widget.onDoubleTapCancel?.call();
    }

    void effectiveOnLongPressStart(LongPressStartDetails d) {
      setHover(ArkHoverStrategy.onLongPressStart);
      final correctedGlobalPosition = correctGlobalPosition(
        context,
        d.globalPosition,
      );
    ...
    void effectiveOnLongPressEnd(LongPressEndDetails d) {
      setHover(ArkHoverStrategy.onLongPressEnd);
      final correctedGlobalPosition = correctGlobalPosition(
        context,
        d.globalPosition,
      );
