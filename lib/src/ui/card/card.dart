...
///
/// The [ArkCard] widget provides a container with a title, description, main
/// content, and optional footer, styled with a background, border, and shadows.
/// It integrates with [ArkTheme] for consistent styling and supports leading
/// and trailing widgets for additional layout flexibility.
final class ArkCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveBorder = border ?? theme.cardTheme.border ?? ArkBorder.all(color: theme.colorScheme.border, width: 1);
