part of 'button.theme.dart';

mixin _$ArkButtonTheme {
  ...
  static ArkButtonTheme? lerp(
    ...
    return ArkButtonTheme(
      ...
      sizesTheme: ArkButtonSizesTheme.lerp(a.sizesTheme, b.sizesTheme, t),
  ...
  ArkButtonTheme copyWith({
    MouseCursor? cursor,
    ArkButtonSize? size,
    ArkButtonSizesTheme? sizesTheme,
    ...
    final _this = (this as ArkButtonTheme);
  ...
  ArkButtonTheme merge(ArkButtonTheme? other) {
    final _this = (this as ArkButtonTheme);
  ...
  bool operator ==(Object other) {
    ...
    final _this = (this as ArkButtonTheme);
    final _other = (other as ArkButtonTheme);
