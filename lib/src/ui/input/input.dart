...
import 'package:flutter_ark/src/ui/disabled/disabled.dart';
import 'package:flutter_ark/src/components/keyboard_toolbar.dart';
...
///
/// The [ArkInput] widget provides a styled text field with support for
/// placeholders, leading/trailing decorations, and extensive text editing features. It integrates
/// with [ArkTheme] for consistent styling and supports advanced interactions
/// like selection, context menus, and autofill.
class ArkInput extends StatefulWidget {
  ...
  /// {@template ArkInput.onPressedOutside}
  ...
  /// {@template ArkInput.onLineCountChange}
  ...
  /// {@template ArkInput.scrollbarPadding}
  ...
  /// {@template ArkInput.editableTextSize}
  ...
  @override
  State<ArkInput> createState() => ArkInputState();
}

class ArkInputState extends State<ArkInput>
  ...
  @override
  void didUpdateWidget(ArkInput oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    (theme.inputTheme.decoration ?? const ArkDecoration()).merge(
      widget.decoration,
    );
...
class _InputSelectionGestureDetectorBuilder
  ...
  _InputSelectionGestureDetectorBuilder({
    required ArkInputState state,
  }) : _state = state,
        super(delegate: state);

  final ArkInputState _state;
