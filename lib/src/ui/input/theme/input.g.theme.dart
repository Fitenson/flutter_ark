...
part of 'input.theme.dart';

// **************************************************************************
// ThemeGenGenerator
// **************************************************************************

mixin _$ArkInputTheme {
  bool get canMerge => true;

  static ArkInputTheme? lerp(ArkInputTheme? a, ArkInputTheme? b, double t) {
    if (identical(a, b)) {
      return a;
    }
  ...
  ArkInputTheme copyWith({
    ...
    final _this = (this as ArkInputTheme);
  ...
  ArkInputTheme merge(ArkInputTheme? other) {
    final _this = (this as ArkInputTheme);
  ...
  bool operator ==(Object other) {
    ...
    final _this = (this as ArkInputTheme);
    final _other = (other as ArkInputTheme);
