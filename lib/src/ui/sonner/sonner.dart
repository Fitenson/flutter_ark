...
///
/// Allows descendants to access the toaster state via [ArkSonner.of] or
/// [ArkSonner.maybeOf] for showing and hiding toasts.
class ArkSonnerScope extends InheritedWidget {
  /// Creates a scope widget that holds the [ArkSonnerState] and child.
  const ArkSonnerScope({
    super.key,
    required super.child,
    required this.shadMessengerState,
  });

  /// The [ArkSonnerState] instance managing toast display.
  final ArkSonnerState shadMessengerState;

  @override
  bool updateShouldNotify(ArkSonnerScope oldWidget) =>
      shadMessengerState != oldWidget.shadMessengerState;
}

/// A widget that manages and displays toasts within the widget tree.
///
/// The [ArkSonner] widget acts as a provider for toast notifications,
...
/// via [ArkSonner.of].
class ArkSonner extends StatefulWidget {
  ...
  /// {@template ArkSonner.visible_toasts_amount}
  ...
  /// {@template ArkSonner.expandedGap}
  ...
  /// {@template ArkSonner.collapsedGap}
  ...
  /// {@template ArkSonner.scaleFactor}
  ...
  /// {@template ArkSonner.animationDuration}
  ...
  /// {@template ArkSonner.animationCurve}
  ...
  @override
  State<ArkSonner> createState() => ArkSonnerState();

  /// Retrieves the [ArkSonnerState] from the nearest [ArkSonner] ancestor.
  ///
  /// Throws a [FlutterError] if no [ArkSonner] is found in the widget tree.
  static ArkSonnerState of(BuildContext context) {
    final provider = maybeOf(context);
    if (provider == null) {
      throw FlutterError(
        '''Could not find ArkSonner InheritedWidget in the ancestor widget tree.''',
      );
    }
    return provider;
  }

  /// Attempts to retrieve the [ArkSonnerState] from the nearest [ArkSonner]
  /// ancestor.
  ///
  /// Returns null if no [ArkSonner] is found, allowing optional access.
  static ArkSonnerState? maybeOf(BuildContext context) {
    final scope = context.dependOnInheritedWidgetOfExactType<ArkSonnerScope>();
...
class ArkSonnerState extends State<ArkSonner> with TickerProviderStateMixin {
  ArkSonnerTheme get sonnerTheme =>
      ArkTheme.of(context, listen: false).sonnerTheme;
  ...
  /// Shows the provided [ArkToast] and returns an identifier for the toast.

  /// The identifier will match the provided [ArkToast.id] if it is not null,
                            ...
                            child: CustomBoxy(
                              ...
                              children: _toasts.mapIndexed((index, toastInfo) {
                                ...
                                switch (toast.variant) {
                                  ArkToastVariant.primary =>
                                  theme.primaryToastTheme,
                                  ArkToastVariant.destructive =>
