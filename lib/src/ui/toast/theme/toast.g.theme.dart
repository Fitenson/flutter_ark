part of 'toast.theme.dart';

mixin _$ArkToastTheme {
  bool get canMerge => true;

  static ArkToastTheme? lerp(ArkToastTheme? a, ArkToastTheme? b, double t) {
    if(identical(a, b)) return a;
    if(a == null) return t == 1.0 ? b : null;
    if(b == null) return t == 0.00 ? a : null;
    ...
    return ArkToastTheme(
      ...
      showCloseIconOnlyWhenHovered: t < 0.5 ? a.showCloseIconOnlyWhenHovered : b.showCloseIconOnlyWhenHovered,
      titleStyle: TextStyle.lerp(a.titleStyle, b.titleStyle, t),
      descriptionStyle: TextStyle.lerp(a.descriptionStyle, b.descriptionStyle, t),
      actionPadding: EdgeInsetsGeometry.lerp(a.actionPadding, b.actionPadding, t),
      border: ArkBorder.lerp(a.border, b.border, t),
      radius: BorderRadius.lerp(a.radius, b.radius, t),
      shadows: t < 0.5 ? a.shadows : b.shadows,
      padding: EdgeInsetsGeometry.lerp(a.padding, b.padding, t),
      closeIconPosition: ArkPosition.lerp(a.closeIconPosition, b.closeIconPosition, t),
  ...
  ArkToastTheme copyWith({
    ...
    ArkPosition? closeIconPosition,
    BoxConstraints? constraints,
    Widget? closeIcon,
    MainAxisAlignment? mainAxisAlignment,
    MainAxisSize? mainAxisSize,
  }) {
    final _this = (this as ArkToastTheme);
  ...
  ArkToastTheme merge(ArkToastTheme? other) {
    final _this = (this as ArkToastTheme);
  ...
  bool operator ==(Object other) {
    ...
    final _this = (this as ArkToastTheme);
    final _other = (other as ArkToastTheme);
